...
Instructions for this can be found in the [solr-ontology-updateprocessor project directory](https://github.com/flaxsearch/BioSolr/tree/master/ontology/ontology-annotator/solr-ontology-updateprocessor).
