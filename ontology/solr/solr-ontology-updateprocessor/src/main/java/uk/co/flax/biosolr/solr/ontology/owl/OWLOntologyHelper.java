...
import uk.co.flax.biosolr.solr.owl.RestrictionVisitor;
...
public class OWLOntologyHelper implements OntologyHelper {
    ...
    public Collection<String> getChildIris(String iri) {
        return getSubclassUris(owlClassMap.get(iri), true);
    }

    @Override
    public Collection<String> getDescendantIris(String iri) {
        return getSubclassUris(owlClassMap.get(iri), false);
    }

    @Override
    public Collection<String> getParentIris(String iri) {
        return getSuperclassUris(owlClassMap.get(iri), true);
    }

    @Override
    public Collection<String> getAncestorIris(String iri) {
        return getSuperclassUris(owlClassMap.get(iri), false);
    }
